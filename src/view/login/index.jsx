    ...
    return (
      ...
      >
        <TweenOne
          ...
          styleName="linked-animate-demo-block-child"
        />
      </div>
...
class LoginView extends Component {
  ...
  render() {
    ...
    const className = 'linked-animate-demo';
    return (
      <div styleName={`${className}-wrapper`}>
        {
        ...
        <div
          styleName={`${className}-box`}
          ref={(c) => { this.box = c; }}
          onMouseMove={this.onMouseMove}
          onMouseLeave={this.onMouseLeave}
        >
          {data.map((item, i) => (
            <Point {...item} tx={tx} ty={ty} key={i.toString()} styleName={`${className}-block`} />
          ))}
        </div>
